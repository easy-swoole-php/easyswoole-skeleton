...
class WebSocketEvent
{
     ...
     * @return bool
     */
    public static function onHandShake(SwooleHttpRequest $request, SwooleHttpResponse $response)
    {
     ...
     * @return bool
     */
    public static function customHandShake(SwooleHttpRequest $request, SwooleHttpResponse $response): bool
    {
        /**
     ...
     * @return bool
     */
    public static function secWebsocketAccept(SwooleHttpRequest $request, SwooleHttpResponse $response): bool
    {
        // ws rfc 规范中约定的验证过程
